...
<link rel="stylesheet" type="text/css" href="<?php echo $WEB_ROOT; ?>css/style.css?v=224">
	...
	<?php  if(false): // Removing this but saving code for future use ?>
		<?php if(strpos($_SERVER['REQUEST_URI'], 'memories') == false): ?>
			<div class="header-ticker">
				<a href="https://pvpoke.com/memories/rankings/">Preview next season</a>
			</div>
		<?php else: ?>
