...
$CANONICAL = '/synergy-finder/' . $cp . '/' . $cup . '/' . $pokemon . '/';

switch($cp){
    case "500":      $league = 'Little Cup'; break;
    case "1500":     $league = 'Great League'; break;
    case "2500":     $league = 'Ultra League'; break;
    case "10000":    $league = 'Master League'; break;
    case "10000-40": $league = 'Master League Classic'; break;
    default:         $league = ''; break;
}

$META_TITLE = 'Synergy Finder - ' . $league . ' PvP';
$META_DESCRIPTION = 'Find the best synergy partners for any Pokemon in ' . $league . '. Analyze type coverage, resistances, and moveset compatibility.';

if($pokemon != ''){
    $name = ucwords(str_replace('_',' ', explode('-', $pokemon)[0]));
    $META_TITLE = 'Synergy Partners for ' . $name . ' - ' . $league;
    $META_DESCRIPTION = 'Discover the best team partners for ' . $name . ' in ' . $league . ' with detailed synergy analysis.';
}
...
<div class="section white synergy-finder-container">
    ...
    <p>Select a Pokémon to find the best team partners with detailed synergy analysis.</p>
...
<div class="section white synergy-results-container hide">
    ...
    <div class="synergy-analysis-info">
        <p>Analyzing synergies with different movesets...</p>
            ...
            <div class="synergy-breakdown">
                ...
                <div class="breakdown-section">
                    ...
                    <table class="scores-table">
                        <tr><td>Weakness Coverage</td><td class="weakness-score">0%</td></tr>
                        <tr><td>Mutual Resistances</td><td class="resistance-score">0%</td></tr>
                        <tr><td>Offensive Coverage</td><td class="coverage-score">0%</td></tr>
                        <tr><td>Role Complement</td><td class="role-score">0%</td></tr>
                        <tr><td>Meta Robustness</td><td class="meta-score">0%</td></tr>
                        <tr class="total-row"><td>Overall Synergy</td><td class="total-score">0%</td></tr>
                    </table>
                </div>
  ...
  $(function(){
    (function waitForGM(){
      try {
        ...
        if (gm && gm.data && Object.keys(gm.data).length > 0) {
          SynergyFinderInterface.getInstance().init();
        } else {
          setTimeout(waitForGM, 50);
        }
      } catch (e) {
        setTimeout(waitForGM, 50);
      }
