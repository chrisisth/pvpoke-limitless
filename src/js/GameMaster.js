...
var GameMaster = (function () {
    ...
    function createInstance(interface) {
		...
		// By default, load the minified version &&(host.indexOf("localhost") == -1)
